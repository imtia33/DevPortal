          ...
          <View style={{
            ...
            >
              <View style={{ flexDirection: "column", gap: 6, padding: 24 }}>
                ...
                <Text style={{ fontSize: 14, color: colors.mutedForeground }}>
                  Monitor your API token status and expiry
                </Text>
              </View>
              <View
              ...
              >
                ...
                >
                  <Text style={{ color: colors.mutedForeground, fontFamily: "monospace" }}>
                    Token: {gitAccToken ? `${gitAccToken.substring(0, 8)}...` : "Not available"}
                  </Text>
                ...
                >
                  <View style={{ flexDirection: "row", alignItems: "center", gap: 12 }}>
                    <View style={{ padding: 8, borderRadius: 50, backgroundColor: `${colors.primary}33` }}>
                      <Icons.Clock style={{ height: 22, width: 22, color: colors.primary }} />
                    </View>
                    <View>
                      <Text style={{ fontWeight: "500", color: colors.cardForeground, fontSize: 16 }}>Token Expires In</Text>
                      <Text
                        style={{
                          fontSize: 24,
                          fontFamily: "monospace",
                          fontWeight: "700",
                          color: tokenExpiry ? colors.primary : colors.mutedForeground,
                          // ...timerPulse,
                        }}
                      >
                        {tokenExpiry ? "Token Active" : "No token"}
                      </Text>
                    </View>
                  </View>
                  <View
                    style={{
                      ...
                      fontSize: 12,
                      fontWeight: "600",
                      backgroundColor: !tokenExpiry ? colors.muted : colors.secondary,
                      color: !tokenExpiry ? colors.mutedForeground : colors.secondaryForeground,
                      gap: 4,
                    }}
                  >
                    {!tokenExpiry ? (
                      <>
                        <Icons.AlertTriangle style={{ height: 14, width: 14, color: colors.mutedForeground }} />
                        <Text style={{ color: colors.mutedForeground, fontSize: 12, fontWeight: "600" }}>No Token</Text>
                      </>
                    ) : (
                      <>
                        <Icons.CheckCircle2 style={{ height: 14, width: 14, color: colors.secondaryForeground }} />
                        <Text style={{ color: colors.secondaryForeground, fontSize: 12, fontWeight: "600" }}>Active</Text>
                      </>
                    )}
                  </View>
                </View>
